...
<title>Cathering - Lavender</title>
<!-- Bootstrap Core CSS -->
...
<div id="carousel-example-generic" class="carousel intro slide">
	...
	<div class="carousel-inner" role="listbox">
		<!-- First slide -->
		<div class="item active" style="background-image:url(img/slidecath1.jpg)">
		...
		<!-- /.item -->
		<!-- Second slide -->
		<div class="item" style="background-image:url(img/slidecath.jpg)">
			<div class="carousel-caption">
				<h2 data-animation="animated zoomInLeft">
				we provide you high taste of </h2>
...
<div class="container">
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1 text-center">
			<h2 class="section-heading">OUR <b>CATHERING</b></h2>
			<hr>
			<p>
				We provide you a high quality of food and bakery
			</p>
			<p>
				That's our duty to serve you and your guests
			</p>
	</div>
</div>
</div>
...
<div class="team-thumb overlay-image view-overlay">
	<img src="img/dijon.jpg" alt="" class="img-responsive">
...
<div class="team-thumb overlay-image view-overlay">
	<img src="img/abc.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 ABC
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/teatro.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				TEATRO
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/gaia.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 GAIA
...
<div class="col-md-4 bg-dark no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/merahputih.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 MERAHPUTIH
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/balibakery.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				BALI BAKERY
