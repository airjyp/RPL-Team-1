...
<title>Decoration - Lavender</title>
<!-- Bootstrap Core CSS -->
...
<div id="carousel-example-generic" class="carousel intro slide">
	...
	<div class="carousel-inner" role="listbox">
		<!-- First slide -->
		<div class="item active" style="background-image:url(img/slidedec.jpg)">
		...
		<!-- /.item -->
		<!-- Second slide -->
		<div class="item" style="background-image:url(img/slidedec1.jpg)">
			<div class="carousel-caption">
...
<div class="container">
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1 text-center">
			<h2 class="section-heading">OUR <b>DECORATION</b></h2>
			<hr>
			<p>
				We provide you a high quality decoration and lighting for your special event
			</p>
			<p>
				That's our duty to make your event looks so elegant and good
			</p>
	</div>
</div>
</div>
...
<div class="team-thumb overlay-image view-overlay">
	<img src="img/mawarprada.jpg" alt="" class="img-responsive">
...
<div class="team-thumb overlay-image view-overlay">
	<img src="img/magical.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 MAGICAL BLOSSOMS
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/delight.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				DELIGHTS
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/aorora.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 AORORA
...
<div class="col-md-4 bg-dark no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/joelle.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 Joelle
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/etcetera.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				ETCETERA
