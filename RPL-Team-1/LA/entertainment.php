...
<title>Entertainment - Lavender</title>
<!-- Bootstrap Core CSS -->
...
<div id="carousel-example-generic" class="carousel intro slide">
	...
	<div class="carousel-inner" role="listbox">
		<!-- First slide -->
		<div class="item active" style="background-image:url(img/slideent.jpg)">
		...
		<!-- /.item -->
		<!-- Second slide -->
		<div class="item" style="background-image:url(img/slideent1.jpg)">
			<div class="carousel-caption">
				<h2 data-animation="animated zoomInLeft">
				we provide you high class of </h2>
...
<div class="container">
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1 text-center">
			<h2 class="section-heading">OUR <b>ENTERTAINMENT</b></h2>
			<hr>
			<p>
				We provide you a high quality of entertainment
			</p>
			<p>
				So, your guest can enjoy your party with full of joy
			</p>
	</div>
</div>
</div>
...
<div class="team-thumb overlay-image view-overlay">
	<img src="img/bebop.jpg" alt="" class="img-responsive">
...
<div class="team-thumb overlay-image view-overlay">
	<img src="img/musicforlife.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 MUSIC FOR LIFE
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/erwinwong.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				ERWIN WONG
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/venus.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 VENUS
...
<div class="col-md-4 bg-dark no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/jennifer.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				 JENNIFER NATASHA
...
<div class="col-md-4 bg-primary no-padding teambox">
<div class="team-thumb overlay-image view-overlay">
	<img src="img/redcarpet.jpg" alt="" class="img-responsive">
	<div class="mask team_quote">
		<div class="port-zoom-link">
			<p>
				RED CARPET
