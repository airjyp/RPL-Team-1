...
if($_POST) {
	...
	$sql = "INSERT INTO customer (id_cust, fname_cust, lname_cust, telephone_cust, email_cust, address_cust, username_cust, password_cust, birthdate, aboutme, active) VALUES ('', '$fname_cust', '$lname_cust', '$telephone_cust', '$email_cust', '','$username_cust', '$password_cust', '', '' ,1) ";
