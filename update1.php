...
<fieldset>
	...
	<form action="modul/prosesupdate.php?id_cust=$data['id_cust']" method="post">
		<table cellspacing="0" cellpadding="0">
			...
			<tr>
				<th>my birthday</th>
				<td><input type="date" name="birthdate_cust" placeholder="birthdate" value="<?php echo $data['birthdate_cust'] ?>" /></td>
			</tr>
			<tr>
				<th>Address</th>
			...
			<tr>
				<th>about me</th>
				<td><input type="text" name="about_cust" placeholder="about"  value="<?php echo $data['about_cust'] ?>" /></td>
			</tr>
